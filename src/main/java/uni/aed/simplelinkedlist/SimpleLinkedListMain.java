...
public class SimpleLinkedListMain {
    ...
    private void testSimpleLinkedList(){
        ...
        System.out.println("Anadiendo un elemento en la posicion 20");
        int result=lista.addToPosition(20, 50);
        if(result==OUT_OF_LIMIT)
            System.out.println("La posicion indicada es incorrecta\n");
        else{
            System.out.println("Anadir elemento fue correcto");
            System.out.println(lista.toString()+"\n");
        }
        
        System.out.println("Anadiendo un elemento en la posicion: 4");
        ...
        System.out.println("Anadiendo un elemento en la posicion: 3");
        ...
        System.out.println("Eliminando el elemento: 60");
        lista.remove(60);
        
        System.out.println("Buscando el elemento: 600");
        result=lista.search(600);
        if(result==NOT_FOUND)
        ...
        System.out.println("\nLa lista contiene "+lista.size()+" elementos");
        System.out.println("Visualizando el contenido de la lista");
        System.out.println(lista.toString());
        
        System.out.println("\nVisualizando la lista de forma inversa");
